...
The per-worker task queue implements the \emph{Chase--Lev} dynamic circular work-stealing deque~\cite[Ref.~54]{yanghe2018survey}, which is the standard lock-free deque used in production work-stealing runtimes such as Cilk. It provides:
